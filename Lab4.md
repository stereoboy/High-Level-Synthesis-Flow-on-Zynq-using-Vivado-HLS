...
4. When the run is completed, expand the **impl** folder in the Explorer view and observe various
    generated directories, such as ip, misc, verilog and vhdl.
...
3. Run the provided script file to create an initial system having zed_audio_ctrl and GPIO
    peripherals by typing the following command:
...
7. Connect the output port of the xlconcat_0 instance to the IRQ_F2P port of the
  ...
  ![Figure13](./images/lab4/Figure13.png)
...
14. Select both **pynq_z2_testapp.c** and **pynq_z2_audio.h** and click Finish to add the file to the project.
