...
2. In the *Module Hierarchy* pane, select the **dct** entry and observe the **RD_Loop_Row_RD_Loop_Col** and
    **WR_Loop_Row_WR_Loop_Col** entries in the *Performance Profile* pane. These are two nested loops flattened and given the new
    names formed by appending inner loop name to the outer loop name. You can also verify this by
...
5. In the *Performance Profile* pane, select the **DCT_Inner_Loop** entry, right-click on the **node_60**
...
3. Select the **dct_1d2** entry in the *Module Hierarchy* pane and observe that the DCT_Outer_Loop
